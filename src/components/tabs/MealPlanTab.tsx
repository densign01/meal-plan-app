            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                {DAYS.map((day) => (
                    <MealListItem
                        key={day.key}
                        day={day}
                        recipe={workingMealPlan.meals[day.key] as Recipe || null}
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex flex-wrap items-center gap-3 mb-4 pb-4 border-b border-gray-200">
                                ...
                                {editingRecipe.recipe.difficulty && (
                                    <span className={`px-3 py-1 rounded-full text-xs font-medium ${editingRecipe.recipe.difficulty === 'beginner' ? 'bg-green-100 text-green-700' :
